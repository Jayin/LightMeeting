...
--
-- Host: localhost    Database: qcdatabase
-- ------------------------------------------------------
...
CREATE TABLE `qc_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8 COMMENT='评论表';
...
INSERT INTO `qc_joinmeet` VALUES (4,1,11,0,1416319788,NULL),(5,124,11,0,1416375149,NULL),(6,125,11,0,1416375599,NULL),(9,127,9,0,1416451128,NULL),(12,126,26,0,1416629119,NULL),(13,0,21,0,1416636939,NULL),(14,0,21,0,1416636953,NULL),(15,0,21,0,1416636963,NULL),(16,0,21,0,1416640375,NULL),(17,0,26,0,1416642080,NULL),(18,0,26,0,1416642101,NULL),(19,0,26,0,1416642112,NULL),(21,0,12,0,1416665733,NULL),(23,0,28,0,1416665830,NULL),(25,128,28,0,1416666019,NULL),(29,128,26,0,1416668180,NULL),(30,128,21,0,1416668479,NULL),(33,128,31,0,1416748477,NULL),(36,128,11,0,1416750463,NULL),(37,128,12,0,1416750498,NULL);
...
CREATE TABLE `qc_research_answer` (
  ...
  `ctime` int(10) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='调查回答表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `qc_research_question` VALUES (4,3,'whar do you like?','JSON字符串'),(5,4,'whar do you like?','JSON字符串'),(7,5,'施工方','{\"1\":\"man\",\"2\":\"woman\"}'),(8,5,'大概','{\"1\":\"man\",\"2\":\"woman\"}'),(9,5,'方便国际饭店','士大夫'),(10,5,'方便国际饭店','士大夫'),(11,5,'方便国际饭店','士大夫'),(12,5,'方便国际饭店','士大夫'),(13,5,'方便国际饭店','士大夫'),(14,5,'方便国际饭店','士大夫'),(15,5,'方便国际饭店','士大夫'),(16,5,'方便国际饭店','士大夫'),(17,5,'方便国际饭店','士大夫'),(18,5,'方便国际饭店','士大夫'),(19,5,'方便国际饭店','士大夫'),(20,5,'方便国际饭店','士大夫'),(21,5,'方便国际饭店','士大夫'),(22,5,'方便国际饭店','士大夫'),(23,5,'方便国际饭店','士大夫'),(24,5,'方便国际饭店','士大夫'),(25,5,'今天你吃饭了吗？','吃了'),(26,5,'今天你吃饭了吗？','吃了'),(27,5,'今天你吃饭了吗？','吃了'),(28,5,'今天你吃饭了吗？','吃了'),(29,5,'今天你吃饭了吗？','吃了'),(30,5,'今天你吃饭了吗？','吃了'),(31,23,'你喜欢袂卓工作室吗','{\"1\":\"喜欢\",\"2\":\"非常喜欢\"}');
...
INSERT INTO `qc_vote_record` VALUES (1,1,1,10,1416378499,'221.4.190.120'),(2,20,2,12,1416471265,'221.4.190.78'),(3,5,2,26,1416629237,'221.4.190.108'),(4,89,14,12,1416800759,'221.4.190.78'),(5,87,14,11,1416816867,'221.4.190.78');
...
-- Dump completed on 2014-11-24 19:32:21
