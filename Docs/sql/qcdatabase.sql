...
--
-- Host: 127.0.0.1
-- Generation Time: 2014-11-27 15:09:46
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `qc_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='评论表' AUTO_INCREMENT=126 ;
...
(105, 36, 0, 26, '我还是觉得每天考勤七次比较好！', 1416664239, '221.4.190.108'),
(106, 36, 0, 28, '放一天假嘛', 1416666086, '221.4.190.108'),
(107, 37, 0, 21, '碉堡', 1416749062, '120.197.196.66'),
(108, 36, 0, 28, '有人不''我试下能不能实时通知', 1416834645, '120.197.196.29'),
(109, 36, 0, 28, '有人不''我试下能不能实时通知', 1416834646, '120.197.196.20'),
(110, 36, 0, 28, '有人不''我试下能不能实时通知', 1416834647, '120.197.196.88'),
(111, 36, 0, 28, '评论了一条''竟然没显示', 1416834675, '120.197.196.5'),
(112, 37, 0, 28, '没显示', 1416834690, '120.197.196.17'),
(113, 36, 0, 12, '还实时通知卧槽', 1416892675, '221.4.190.78'),
(114, 36, 0, 12, '我改一下评论自动刷新', 1416892703, '221.4.190.78'),
(115, 36, 0, 12, '早上在改评论界面！发送按钮在下面太蛋疼了', 1416892749, '221.4.190.78'),
(116, 36, 0, 12, '我喜欢', 1416894254, '221.4.190.78'),
(117, 36, 0, 12, '酷炫的新评论界面', 1416898646, '221.4.190.78'),
(118, 36, 0, 12, '又改了评论的生成', 1416922703, '221.4.190.122'),
(119, 36, 0, 12, '好像刷新有bug', 1416922745, '221.4.190.122'),
(120, 36, 0, 12, '好像刷新有bug', 1416922760, '221.4.190.122'),
(121, 36, 0, 12, '果然有bug', 1416922867, '221.4.190.122'),
(122, 36, 0, 12, 'bug修好了？', 1416923029, '221.4.190.122'),
(123, 36, 0, 33, '我靠碉堡了', 1417074563, '183.54.70.98'),
(124, 36, 0, 33, '66666meizhuo加油', 1417074733, '183.54.70.98'),
(125, 36, 0, 12, '233333', 1417075261, '221.4.190.15');
...
CREATE TABLE IF NOT EXISTS `qc_discuss` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='讨论表' AUTO_INCREMENT=39 ;
...
(35, 126, 26, '我是你爸爸', '我就是你爸爸', 1416651732),
(36, 128, 26, '考勤制度', '1. 每周至少签到六次，连续三周考勤次数不够，负责人将会予以劝退。\n2. 考勤为填表的形式，负责人会不定时检查，严格惩罚弄虚作假。\n3. 切记每次到来工作室填写好考勤表。\n4. 考勤表每周一更换一次，由负责人负责打印出来。', 1416664046),
(37, 128, 26, '项目制度', '1. 以指导老师以及负责人下达的项目优先，项目进度须每周在会议上总结报告。\n2. 工作室成员自行接项目须向负责人说明，以工作室内部成员为主体展开项目，并且每周在会议上总结报告。\n3. 项目过程由各个小组长协调安排人手，在小组长的带领下完成。如无项目在做，小组长须适当安排学习任务，并且实时跟进。', 1416664070),
(38, 128, 26, '开会制度', '1. 每周召开部门会议，每两周召开全体会议，开全体会议的一周不强求召开小组会议，全体会议之后，小组长可以自行安排小组会议。\n2. 例会请假需告知负责人，待允许后方可缺席。无故缺席三次者将予以劝退。例会时间：每周五晚10点。\n3. 小组会议由各小组长组织召开，全体会议由负责人组织召开。\n4. 小组会议内容主要为学习进度以及项目进度总结，提出问题，共同商讨解决问题的方案。全体会议上小组长须向负责人报告小组成员的状况，以及在做项目进度等。全体会议上可以提出工作室完善方面的具有建设性的建议。', 1416664092);
...
INSERT INTO `qc_joinmeet` (`id`, `meetid`, `memberid`, `checkin`, `powerid`, `stime`, `checkin_time`) VALUES
(4, 1, 11, 0, 0, 1416319788, NULL),
(5, 124, 11, 0, 0, 1416375149, NULL),
(6, 125, 11, 0, 0, 1416375599, NULL),
(9, 127, 9, 0, 0, 1416451128, NULL),
(12, 126, 26, 0, 0, 1416629119, NULL),
(13, 0, 21, 0, 0, 1416636939, NULL),
(14, 0, 21, 0, 0, 1416636953, NULL),
(15, 0, 21, 0, 0, 1416636963, NULL),
(16, 0, 21, 0, 0, 1416640375, NULL),
(17, 0, 26, 0, 0, 1416642080, NULL),
(18, 0, 26, 0, 0, 1416642101, NULL),
(19, 0, 26, 0, 0, 1416642112, NULL),
(21, 0, 12, 0, 0, 1416665733, NULL),
(23, 0, 28, 0, 0, 1416665830, NULL),
(25, 128, 28, 0, 0, 1416666019, NULL),
(29, 128, 26, 0, 0, 1416668180, NULL),
(30, 128, 21, 0, 0, 1416668479, NULL),
(33, 128, 31, 0, 0, 1416748477, NULL),
(36, 128, 11, 0, 0, 1416750463, NULL),
(37, 128, 12, 0, 0, 1416750498, NULL),
(38, 128, 33, 0, 0, 1417074535, NULL);
...
(126, 'ThinkPHP分享会', '讲述使用ThinkPHP时跳过的坑', '北主楼1608', 12, 0, 1416368460, 1416454860),
...
(12, 'jacky', 'jacky', 'b59c67bf196a4758191e42f76670ceba', 'm', NULL, NULL, NULL, '771993313@qq.com', 1416844800, 1416366515, '221.4.190.91', 1416366515, '221.4.190.91'),
...
(26, 'zhlhuang', '黄振炼', '698d51a19d8a121ce581499d7b701668', 'm', NULL, NULL, '15088132444', '364626853@qq.com', 729964800, 1416629070, '221.4.190.108', 1416629070, '221.4.190.108'),
(27, 'jason', '杨先生', 'b59c67bf196a4758191e42f76670ceba', 'm', NULL, NULL, NULL, '782394631@qq.com', 0, 1416662996, '221.4.190.48', 1416662996, '221.4.190.48'),
(28, 'Simon', '杨生', '827ccb0eea8a706c4c34a16891f84e7b', 'm', NULL, NULL, NULL, '1944291295@qq.com', 0, 1416665781, '221.4.190.108', 1416665781, '221.4.190.108'),
(29, 'Lov_MP', '梦梦哒', '486cd6aaa144f8b8e3e52236a9a504b3', 'f', NULL, NULL, NULL, '910858020@qq.com', 0, 1416667542, '27.45.2.22', 1416667542, '27.45.2.22'),
(30, 'qqq', 'abc', '698d51a19d8a121ce581499d7b701668', 'm', NULL, NULL, NULL, '36666@qq.com', 0, 1416704461, '27.45.39.94', 1416704461, '27.45.39.94'),
(31, 'zjien', 'zjien', '71e965caeeb88b7eb383d999566e293b', 'm', NULL, NULL, NULL, '694396727@qq.com', 0, 1416748360, '221.4.190.108', 1416748360, '221.4.190.108'),
(32, 'zjien1', 'zjien1', '71e965caeeb88b7eb383d999566e293b', 'm', NULL, NULL, NULL, '1873866421@qq.con', 0, 1416749081, '221.4.190.108', 1416749081, '221.4.190.108'),
(33, 'xo5506589', 'huangruichang', '2c14e97e90f1f5196f8828e2cec67d67', 'm', NULL, NULL, NULL, '532079207@qq.com', 0, 1417073934, '183.54.70.98', 1417073934, '183.54.70.98');
...
CREATE TABLE IF NOT EXISTS `qc_research` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='调查表' AUTO_INCREMENT=24 ;
...
(23, 128, '你觉得袂卓移动开发工作室是一个什么样的地方?', '袂卓移动开发工作室是一个温馨的大家庭', 1399305600, 1404748800);
...
CREATE TABLE IF NOT EXISTS `qc_research_answer` (
  ...
  `ctime` int(10) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='调查回答表' AUTO_INCREMENT=40 ;
...
(34, 31, 2, '非常喜欢', 12, 1416809210),
(35, 31, 1, '喜欢', 21, 1416971518),
(36, 31, 2, '非常喜欢', 12, 1416984961),
(37, 31, 1, '喜欢', 12, 1417070083),
(38, 31, 2, '非常喜欢', 12, 1417070098),
(39, 31, 2, '非常喜欢', 33, 1417074633);
...
CREATE TABLE IF NOT EXISTS `qc_research_question` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='调查问题表' AUTO_INCREMENT=32 ;

--
-- 转存表中的数据 `qc_research_question`
--

INSERT INTO `qc_research_question` (`id`, `researchid`, `title`, `options`, `option_type`) VALUES
(4, 3, 'whar do you like?', 'JSON字符串', 1),
(5, 4, 'whar do you like?', 'JSON字符串', 1),
(7, 5, '施工方', '{"1":"man","2":"woman"}', 1),
(8, 5, '大概', '{"1":"man","2":"woman"}', 1),
(9, 5, '方便国际饭店', '士大夫', 1),
(10, 5, '方便国际饭店', '士大夫', 1),
(11, 5, '方便国际饭店', '士大夫', 1),
(12, 5, '方便国际饭店', '士大夫', 1),
...
CREATE TABLE IF NOT EXISTS `qc_vote` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投票表' AUTO_INCREMENT=15 ;
...
(14, 128, '关于选取袂卓移动公开发工作室新一任HR', '关于选取袂卓测试数据：移动公开发工作室新一任HR，移动公开发工作室新一任HR，移动公开发工作室新一任HR', 1416796421, 1399392000, 1402156800);
...
CREATE TABLE IF NOT EXISTS `qc_vote_option` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='选项表' AUTO_INCREMENT=90 ;
...
CREATE TABLE IF NOT EXISTS `qc_vote_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投票记录' AUTO_INCREMENT=7 ;
...
(4, 89, 14, 12, 1416800759, '221.4.190.78'),
(5, 87, 14, 11, 1416816867, '221.4.190.78'),
(6, 87, 14, 33, 1417074608, '183.54.70.98');
